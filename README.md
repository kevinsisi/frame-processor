...
固定 `denoise → lens_distort → level_correct → auto_crop → cpl_look → color_grade`。每階段獨立 toggle；理由見 `ARCHITECTURE.md` § Pipeline 順序 與 `docs/adr/0002-bundled-v0.2.0-processing.md`。
